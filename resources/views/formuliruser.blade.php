                            ...
                            <div class="container-fluid rounded mt-4">
                                <form action="/user/simpanuser" method="POST">
                                    ...
                                    <div class="form-group w-25">
                                        ...
                                        <input type="number" name="nik_user" class="form-control" placeholder="Masukkan NIK" required autofocus>
                                     </div>
                                    <div class="form-group w-25">
                                    ...
                                    <div class="form-group w-25">
                                        ...
                                        <input type="text" name="no_handphone" class="form-control" placeholder="Masukkan No. Handphone" required>
                                    </div>
                                    <div class="form-group w-25">
